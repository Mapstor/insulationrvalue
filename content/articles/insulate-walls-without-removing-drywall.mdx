...
**5. DIY attempt at dense-pack.** Consumer blowing machines from Home Depot/Lowe's can't generate the pressure required for proper dense-pack installation. DIY installations typically achieve only 1.5 lb/ft³ density (half the 3 lb/ft³ required for proper dense-pack) — the material settles within a year, leaving the top 18 inches of every wall empty. This is a professional job.
