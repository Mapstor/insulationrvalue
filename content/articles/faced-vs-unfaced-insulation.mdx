...
This is the most commonly documented moisture failure mode tied to faced insulation — and it's entirely preventable.

**What happens:** A homeowner in zone 5 has R-19 kraft-faced batts in the attic floor (facing down, toward the heated ceiling — correct). They want to add R-41 to reach R-60 (current IECC for zone 5). They buy kraft-faced R-30 batts and lay them on top to add what they can, creating this assembly:
...
**1. Facing toward the wrong side.** In heating climates (zones 5+), the facing must go toward the warm interior. Installations with kraft facing placed toward the cold exterior trap interior moisture against the cold sheathing, causing condensation and rot. Remember: facing toward the warm side, always.
