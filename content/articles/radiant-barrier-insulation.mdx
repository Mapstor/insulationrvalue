...
**What this means for code compliance:** A radiant barrier does NOT count toward your attic's R-value requirement. Your attic still needs R-30 to R-60 of actual insulation ([by climate zone](/r-value-calculator/)) whether or not a radiant barrier is installed. The barrier is an addition, not a substitute.
...
Zero. Radiant barriers work by reflecting radiant heat, not by resisting conductive heat transfer ([which is what R-value measures](/what-is-r-value/)). Any product marketed with an "R-value equivalent" for a radiant barrier is misleading. The radiant barrier benefit is real but operates on a completely different mechanism than R-value. Your attic still needs R-30 to R-60 of actual insulation by [code](/r-value-calculator/), depending on climate zone.

### Do I need a radiant barrier in a cold climate?

Almost certainly not. Radiant barriers primarily reduce cooling costs. In heating-dominant climates (zones 5–8), conductive heat loss through the ceiling is the dominant concern — addressed by [insulation](/attic-insulation/) and [air sealing](/how-to-air-seal-attic/), not radiant barriers. The 1–2% heating benefit in cold climates doesn't justify the cost. Invest in R-60 attic insulation (the 2021 IECC minimum for zones 4–8) and thorough air sealing instead.
