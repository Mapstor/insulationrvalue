...
export const alt = 'What Insulation Do I Need? - Free Quiz & Recommendations'
export const size = {
  width: 1200,
  height: 630,
}
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Take the Quiz - Get Personalized Recommendations
        </h2>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', color: 'white', fontSize: 22 }}>
            <span style={{ marginRight: 8 }}>✓</span> 5 Quick Questions
          </div>
          <div style={{ display: 'flex', alignItems: 'center', color: 'white', fontSize: 22 }}>
            <span style={{ marginRight: 8 }}>✓</span> Personalized Results
          </div>
          <div style={{ display: 'flex', alignItems: 'center', color: 'white', fontSize: 22 }}>
            <span style={{ marginRight: 8 }}>✓</span> Cost Estimates
          </div>
        </div>
