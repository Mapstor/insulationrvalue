...
export const alt = 'Insulation Cost Calculator - Estimate Material & Labor Costs'
export const size = {
  width: 1200,
  height: 630,
}
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Estimate Material & Installation Costs
        </h2>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', color: 'white', fontSize: 22 }}>
            <span style={{ marginRight: 8 }}>✓</span> DIY vs Pro Costs
          </div>
          <div style={{ display: 'flex', alignItems: 'center', color: 'white', fontSize: 22 }}>
            <span style={{ marginRight: 8 }}>✓</span> 10+ Material Types
          </div>
          <div style={{ display: 'flex', alignItems: 'center', color: 'white', fontSize: 22 }}>
            <span style={{ marginRight: 8 }}>✓</span> 2024 Pricing
          </div>
        </div>
